...
LaborManager.prototype.add = function(labor) {
    var self = this
...
LaborManager.prototype.remove = function(laborId) {
    var self = this
    var labor
...
LaborManager.prototype.distribute = function(order) {
    var self = this
 ...
 */
LaborManager.prototype._distribute = function() {
    var self = this
...
LaborManager.prototype.list = function() {
    ...
    var fn = function(laborId, idx, labors) {
        var labor = self.labors[laborId] || self.busyLabors[laborId]
