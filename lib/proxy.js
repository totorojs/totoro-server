...
function request(order, p, req, cb) {
    ...
    socket.request(opts, cb)


    // requestClient(order, opts, cb)
}

function requestClient(order, opts, cb) {
