...
var defaultAdapters = ['mocha', 'jasmine']
...
function adapt(content, adapter, callback) {
    ...
    if (common.isUrl(adapter) || defaultAdapters.indexOf(adapter) > -1) {
